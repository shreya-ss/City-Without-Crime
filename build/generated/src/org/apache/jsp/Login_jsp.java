...
public final class Login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <center>\n");
      out.write("         \n");
      out.write("        <h2 style=\"color: midnightblue;\">LOGIN AS ADMINISTRATOR</h2><hr>\n");
      out.write("        ");
String s=(String)request.getAttribute("msg");
  ...
  private boolean _jspx_meth_h_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_h_form_0.setAction("/logadmin");
    int _jspx_eval_h_form_0 = _jspx_th_h_form_0.doStartTag();
    if (_jspx_eval_h_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("        <h3>\n");
        out.write("            <!--Enter Password : <input type=\"password\" name=\"apass\"/><br><br>-->\n");
        out.write("            Enter Password : <input type=\"password\" name=\"apass\"><br><br>\n");
        out.write("            ");
        ...
        out.write("</h2>\n");
        out.write("            ");
        if (_jspx_meth_h_reset_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_h_form_0, _jspx_page_context))
          return true;
        out.write("</h2><br><br></h3>\n");
        out.write("        ");
