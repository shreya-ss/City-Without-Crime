...
public final class StationBody_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.println("NO  ANY  COMPLAINT  IN  THIS  AREA");
      ...
      out.write("\n");
      out.write("         <h1 style=\"letter-spacing: 1px\">Complaints</h1>\n");
      out.write("         <hr><br><br>\n");
      ...
      out.write("\n");
      out.write("             <br><br><br>\n");
      out.write("        <table border=\"1\" width=\"600\" style=\"font-family: serif;color: #333333;\"><tr>\n");
...
while(rs.next()){
      ...
      out.write("                    <td>\n");
      out.write("                    \n");
      out.write("        <span style=\"margin-left: 10px;letter-spacing: 1px;\">\n");
      out.write("                    ");
...
try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Police","root","password");
            PreparedStatement pst=con.prepareStatement("select * from emergency where p_id=?");
            pst.setString(1, (String)request.getSession().getAttribute("pid"));
            ResultSet rs=pst.executeQuery();
            if(!rs.isBeforeFirst()){
